            ...
            <div className='md:w-[1317.61px] h-[988px] flex flex-col md:flex-row mt-[40px]'>
               {/* start */}
                   <div >
                          ...
                          <div className='w-[348px] h-[37px] mt-[30px] ml-[px] md:hidden'>
                           ...
                           <div  className=' w-[327.45]  mt-[40px] md:w-[873.88px] md:h-[874px] '>
                               {cartItems.map(item=>(
               ...
               {/* start */}
                   <div className=''>
                       ...
                       <div className='w-[327.21px] h-[149px] mt-[36px] md:mt-[120px]  border-t-[2px] border-r-0 border-l-0 border-b-0 md:border-t-0 '>
