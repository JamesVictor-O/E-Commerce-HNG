         ...
         <div className="absolute inset-0 bg-custom-overlay opacity-75">
             <div className="relative z-10">
                  <div className='w-full h-[339.75px] mx-3 md:mx-0 md:ml-[74.38px]  mt-[42.36px] flex md:justify-between flex-col'>
                       ...
                       <div className='w-full h-[149.66px] mt-24 md:mt-0'>
                           <div className='w-full max-w-[365px] h-[79.13px] text-white'>
                              ...
                              <h2 className='w-full h-[50px] font-semibold text-2xl md:text-[41.32px] leading-[50.37px]'>
                                 Denim Totebags
                              </h2>
                           </div>
                           <p className='w-full  h-[54px] font-medium leading-[27px] text-white'>Totebag’s made with jean fabric to meet your fashion taste</p>
                       </div>
                  </div>
            </div>
         </div>
