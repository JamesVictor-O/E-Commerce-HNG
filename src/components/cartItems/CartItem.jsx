                        ...
                        <div className=" w-[219.35px] h-[54.29px] md:w-[645.71px] md:h-[114px]  px-[0px] gap-[16px] ">
                         ...
                         <div className="w-[310px] h-[53px] md:w-[490.32px] md:h-[159.37px] gap-[16px] mt-[140px] md:mt-[50px] "> 
                            <div className="mb-4">
                                ...
                                <option className="text-[#005A59] bg-gray-500 " value="">select your Location</option>
                            ...
                            <button className="hidden md:block w-[310px] bg-gray-400 h-[48px] md:w-[490.32px] mb-3 md:h-[61.8px] rounded-[5.98px] hover:bg-white border-[1.4px] py-[10px] md:py-[19.66px] px-[19.4px] hover:text-black  text-white font-semibold">Buy Now</button>
                        
                            <div onClick={(e => HandleAddItemToCart(cartItems,name,imageUrl,price,id,setCartItems))}>
