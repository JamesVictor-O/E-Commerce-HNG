  ...
  return (
    <div className="relative mt-4  max-w-[328px] ml-[10px] md:mt-10 gap-5 md:max-w-[1329px]">
        <div className="w-[326px] h-[40px] md:w-[552px] md:h-[82px] mb-3 md:mb-0 ">
            ...
            <h6 className="w-[326px] h-[14px] text-[18px] tracking-[-0.6px] font-normal text-[#4E5050] md:w-[522px] md:h-[28px] md:text-[24px] md:leading-[28.18px] font-thin">Discover our Leatest collecton of bags</h6>
        </div>
        <div 
