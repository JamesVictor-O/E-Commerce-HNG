...
const AvailableStock = () => {
  ...
  return (
    <div className="relative mt-4  w-[100%]  md:mt-10 gap-5 md:max-w-[1329px]  px-8 py-3 md:px-2">
        ...
        <div 
        className=" grid grid-cols-2 gap-3 md:gap-6 md:grid-cols-4  no-scrollbar "
        >
