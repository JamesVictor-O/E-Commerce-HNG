...
const AvailableStock = () => {
  ...
  return (
    <div className="relative top-[80px] w-[348px] ml-[10px] gap-5 md:pl-8 h-[1058px] md:w-[1400px] md:h-[1535px] ">
        ...
        <div className="flex gap-[24px] md:gap-0 flex-row flex-wrap w-[398px] h-[1016px]  justify-center items-center overflow-x-auto md:overflow-x-visible no-scrollbar  md:w-[1400px]  md:h-[1329px]">
