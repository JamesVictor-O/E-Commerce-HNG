...
const ItemCategories = () => {
  ...
  return (
    <div className=' w-full h-[50px] md:h-[56px] pl-[160px] md:mb-2 md:ml-0 md:pl-0 no-scrollbar overflow-x-auto  md:w-[629px] flex justify-center items-center align-middle'>
      <div  onClick={handleOnClick} className='w-[726px]  h-full md:w-[629px] items-end md:items-center md:h-[56px] flex flex-row justify-between '>
